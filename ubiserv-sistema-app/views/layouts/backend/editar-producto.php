...
<?php include('includes/menu-admin.php') ?>
        ...
        <div class="container">
          <div class="col-md-11 centrado">
            <ul class="rutas list-inline">
              ...
              <li><a href="<?= $path; ?>/admin/nuevo-producto/<?= $id_proveedor; ?>/<?= $id_categoria; ?>/<?= $id; ?>"><b>Editar Producto</b></a></li>
            </ul>
          </div>
        </div>
      </div>
      ...
      <div class="row">
        ...
        <?php if( $permisos->tipo_usuario(array('superadmin')) ){ ?>
          ...
          <?php $productos->ver('editar', array('id' => $id, 'id_proveedor' => $id_proveedor, 'id_categoria' => $id_categoria)); ?>
        <?php }else{
          $permisos->denegado();
        } ?>
